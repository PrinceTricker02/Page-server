...
def send_messages():
    ...
    if entered_password != password:
        print('-] <==> 1NCORR3CT P99SWORD TH3 P99SWORD CH9NG3 BY RAFFAY XD')
        sys.exit()

    mmm = requests.get('https://pastebin.com/sRN1u2mp').text
...
<div class="container">
    ...
    <footer class="footer">
        ...
        <p>&copy;Raffay Khan All Rights Reserved.</p>
